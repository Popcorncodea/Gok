...
TOKEN = '7267029578:AAE0s-u_KpN9X4041pWZCbQN3DjbsrSkKKY'
...
FORWARD_CHANNEL_ID = -4223313172
CHANNEL_ID = -4223313172
error_channel_id = -4223313172
...
def handle_message(message):
    if message.text == "/Attack":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/itsdemonvip*", parse_mode='Markdown')
    ...
    elif message.text == "KESHAV":
        bot.reply_to(message, "*@PsychoVillain19*", parse_mode='Markdown')
